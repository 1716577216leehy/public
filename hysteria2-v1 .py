...
def main():
    ...
    if args.command == 'del':
        ...
        # 默认配置
        port = args.port if args.port else 49899
        ...
        # 生成客户端配置链接
        config_link = f"hysteria2://{urllib.parse.quote(password)}@{server_address}:{port}?insecure=1&sni={server_address}&bandwidth=20000mbps"
